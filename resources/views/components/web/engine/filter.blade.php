<div class="search-filter-section">
    ...
    <div class="heading">
        ...
        <h4 class="title">{{ trans('Filters') }}</h4>
    </div>
    <div class="tour-search">
        ...
        <div class="select-dropdown-section">
            <div class="d-flex gap-10 align-items-center">
                ...
                <h4 class="select2-title">{{ _('Species') }}</h4>
            </div>
        ...
        <div class="select-dropdown-section">
            <div class="d-flex gap-10 align-items-center">
                <i class="ri-flight-takeoff-fill"></i>
                <h4 class="select2-title">{{ _('Races') }}</h4>
            </div>
            <select class="destination-dropdown">
        ...
        <div class="select-dropdown-section">
            <div class="d-flex gap-10 align-items-center">
                <i class="ri-flight-takeoff-fill"></i>
                <h4 class="select2-title">{{ _('Sex') }}</h4>
            </div>
            <select class="destination-dropdown">
    ...
    <div class="heading">
        ...
        <h4 class="title">Filter By Age</h4>
    </div>
    <div class="price-range-slider">
        <div id="slider-range" class="range-bar"></div>
        <div class="d-flex justify-content-between align-items-center">
            <div class="range-value">
                <p class="pera">age: </p> <input type="text" id="amount" readonly>
    ...
    <div class="heading">
        ...
        <h4 class="title">Pet sitter Rating</h4>
    </div>
